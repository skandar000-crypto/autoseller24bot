...
faq_data = [
    ...
    },
    {
        ...
        "answer": "Стоимость оказания наших услуг составляет от 30 000 руб."
    },
    {
...
async def purchase_flow_handler(message: Message, state: FSMContext):
    ...
    part1 = (
        ...
        "1️⃣ <b>Предварительный созвон</b>\n"
        "После того, как мы получаем заявку, с Вами связывается наш менеджер.\n"
        "Обговаривются все детали и мы приступаем к поискам автомобиля.\n"
        "💰 Наша комиссия от 30 000 руб.\n\n"
    ...
    part2 = (
        ...
        "После выигрыша остальные ставки отменяем.\n"
    ...
    part3 = (
        ...
        "💳 Оплата возможна в Сбербанке или во Владивостоке.\n\n"
