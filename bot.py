...
faq_data = [
    ...
    },
    {
        ...
        "answer": "Финальная стоимость — это не только цена на аукционе. К ней добавляются: аукционный сбор, доставка по Японии до порта, морской фрахт, таможенная пошлина, утилизационный сбор и комиссия компании."
    },
    {
        "question": "Стоимость услуг компании AutoSeller24?",
        "answer": "Стоимость оказания наших услуг составляет 30 000 руб."
    },
    {
...
async def purchase_flow_handler(message: Message, state: FSMContext):
    ...
    part2 = (
        ...
        "🎥 Видеоинструкция: <a href=\"https://vk.com/video-221383225_456239178?access_key=d318be29d3e71130af\">vk.com/video-221383225_456239178</a>\n"
    )
